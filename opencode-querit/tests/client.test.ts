...
describe("QueritClient", () => {
  ...
  it("parses contents responses with statuses and metadata", async () => {
    const fetch = vi.fn(async () => jsonResponse({
      results: [
        {
          id: "1",
          url: "https://example.com/a",
          content: "hello",
          extrasMeta: { title: "T", siteName: "Ex", publishTime: "2026-01-01" },
        },
    ...
    expect(response.results).toEqual([
      {
        ...
        url: "https://example.com/a",
        content: "hello",
        metadata: { title: "T", url: undefined, publishTime: "2026-01-01", siteName: "Ex", siteIcon: undefined },
      },
    ]);
